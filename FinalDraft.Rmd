...
Bank = Bank.Ori[samp,]
Bank = Bank[-11773,]  # remove what seems to be human error
Bank.Scaled = Bank
...
```{r}
# lapply(Bank,class) check which is numeric / categorical
...
#sil =  c(NA, 0.1507379, 0.1427649, 0.1473079, 0.1394863, 0.1505739, 0.1507535, 0.1508811)
...
```{r,eval=FALSE}
# prepping for cross-validation withouut variable duration
